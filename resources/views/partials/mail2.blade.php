                     ...
                     <tr>
                        <td align="left" valign="top">
                           ...
                           <a href="#" target="_blank" style="display: block; max-width: 128px;">
                              <img src="{{url('admin/images/auth/logo.png')}}" alt="img" width="128" border="0" style="display: block; width: 128px;" />
                           </a>
                     ...
                     <tr>
                        <td align="left" valign="top">
                           <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
                              ...
                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 34px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">Hola, 
                                    </span>
                           ...
                           <font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 18px; line-height: 32px;">
                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;">Bienvenido a Beehive</span>
                           </font>

                           <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>

                            <font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 12px; line-height: 32px;">
                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;"> <br>
                               ...
                               <font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 12px; line-height: 32px;">
                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;">www.beehive.com/login
                              </span>
                                 ...
                                 <tr>
                                    <td align="center" valign="top">
                                       ...
                                       <div style="display: block; max-width: 50px;">
                                          <img src="admin/images/email/rad.png" alt="img" width="50" border="0" style="display: block; width: 50px;" />
                                       </div>
                                    </td>
                                 </tr>
                              </table>
                                 ...
                                 <tr>
                                    <td align="center" valign="top">
                                       ...
                                       <div style="display: block; max-width: 177px;">
                                          <img src="admin/images/email/txt.png" alt="img" width="177" border="0" style="display: block; width: 177px; max-width: 100%;" />
                                       </div>
                                    </td>
                                 </tr>
                              </table>
                                       ...
                                       <tr>
                                          <td align="center" valign="top">
                                             <a href="#" target="_blank" style="display: block; max-width: 19px;">
                                                <img src="admin/images/email/soc_1.png" alt="img" width="19" border="0" style="display: block; width: 19px;" />
                                             </a>
                                          </td>
                                          <td width="45" style="width: 45px; max-width: 45px; min-width: 45px;">&nbsp;</td>
                                          <td align="center" valign="top">
                                             <a href="#" target="_blank" style="display: block; max-width: 18px;">
                                                <img src="admin/images/email/soc_2.png" alt="img" width="18" border="0" style="display: block; width: 18px;" />
                                             </a>
                                          </td>
                                          <td width="45" style="width: 45px; max-width: 45px; min-width: 45px;">&nbsp;</td>
                                          <td align="center" valign="top">
                                             <a href="#" target="_blank" style="display: block; max-width: 21px;">
                                                <img src="admin/images/email/soc_3.png" alt="img" width="21" border="0" style="display: block; width: 21px;" />
                                             </a>
                                          </td>
                                          <td width="45" style="width: 45px; max-width: 45px; min-width: 45px;">&nbsp;</td>
                                          <td align="center" valign="top">
                                             <a href="#" target="_blank" style="display: block; max-width: 25px;">
                                                <img src="admin/images/email/soc_4.png" alt="img" width="25" border="0" style="display: block; width: 25px;" />
                                             </a>
                                          </td>
                                       </tr>
                                    </table>
