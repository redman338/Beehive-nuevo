    ...
    <div class="col-lg-12 col-md-12 col-xs-12">
        ...
        <div class="row">  
                    ...
                    <label class="col-sm-5 col-form-label">Copropiedad :</label>
                      <div class="col-sm-7">
                         ...
                         [ null => '-- Selecciona ---']+ $copropiedades,
                          null, 
                          ['class' => 'form-control form-txt-primary form-control-primary', 'id'=>'copropiedad_id']) !!}
            ...
            <div class="col-lg-12 ">
              ...
              <div class="form-group row">
                  <label class="col-sm-5 col-form-label">Fecha Limite Sin Recargo</label>
                    <div class="col-sm-7">
                            {{ Form::date('daysinrecargo', null, ['class' => 'form-control form-txt-primary form-control-primary', 'id' => 'description', ]) }}
                    </div>
              </div>
            ...
            <div class="col-lg-12 ">
              ...
              <div class="form-group row">
                  <label class="col-sm-5 col-form-label">Fecha Limite Con Regargo</label>
                    <div class="col-sm-7">
                            {{ Form::date('dayrecargo', null, ['class' => 'form-control form-txt-primary form-control-primary', 'id' => 'description', 'placeholder' => 'Descripcion']) }}
                    </div>
              </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                     ...
                     <div class="col-sm-5">
                         ...
                         {{ Form::text('valor', null, ['class' => 'form-control form-txt-primary form-control-primary', 'id' => 'description', 'placeholder' => '$']) }}
