            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="d-flex justify-content-between bd-highlight mb-3"> 
                  ...
                  <h5>Informacion del Tipo de Copropiedad</h5>
                    ...
                    @include('admin.miregistro.tipocopropiedad.partials.form')
                     ...
                     <div class="row">
                       <div class="col-lg-12 col-sm-12 mob-product-btn">
                            ...
                            <a href="{{route('tipocopropiedad.index')}}" class="btn btn-inverse waves-effect waves-inverse"><i class="icofont icofont-close f-16"></i>Regresar</a>
