            ...
            <div class="card ">
              ...
              <div class="row ml-5">
                  ...
                  <div class="col-md-6">
                    ...
                    <h6>Nombre / Codigo : {{ $inmueble->name }}</strong></h6>
                ...
                <div class="col-md-10">
                   <h4 class="text-primary">Datos del Propietario </h4>
                    <div class="info p-t-10">
                       <h6>Nombre completo / Razon Social : <strong> {{ $inmueble->profile->name }}</strong> </h6>

                       <h6>Cedula / Nit : <strong> {{ $inmueble->profile->nit }}</strong> </h6>

                       <h6>Telefono : <strong> {{ $inmueble->profile->phone_1 }}</strong> </h6>

                       <h6>Email : <strong> {{ $inmueble->profile->email }}</strong> </h6>
