        ...
        <div class="col-md-12 col-sm-9 col-md-7 col-lg-10 text-center p-0 mt-3 mb-2">
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                ...
                <div class="row">
                   ...
                   <form id="form_prop_residente_1" class="msform">
                                            ...
                                            <div class="col-md-6 col-lg-6 col-xs-12">
                                              {{ Form::label('Nombre', 'Nombre Residente 2: *')}}
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  {{ Form::text('residente2', null, ['class' => 'form-control form-txt-primary form-control-primary', 'id' => 'residente2', 'placeholder' => 'Nombre completo']) }}
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-xs-12">
                                              {{ Form::label('vehiculo_tipo', 'Vehiculo Tipo: *')}}
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  {{ Form::text('vehiculo_tipo', null, ['class' => 'form-control form-txt-primary form-control-primary', 'id' => 'vehiculo_tipo', 'placeholder' => 'Tipo Vehículo']) }}
                                                </div>
                                            </div>
