              ...
              <div class="prod-item text-center">
                 <div class="prod-img">
                      <div class="option-hover">
                          ...
                          <a href="{{url('cliente/zona', $zona->slug )}}" class="btn btn-primary btn-icon waves-effect waves-light m-r-15 hvr-bounce-in option-icon">
                              <i class="icofont icofont-eye-alt f-20"></i>
                          </a>
                          
                      </div>
                      <a href="{{url('cliente/zona', $zona->slug )}}" class="hvr-shrink">
                         @if($zona->file)
                      ...
                      <div class="p-new"><a href="">Reservar </a></div>
                          ...
                          <div class="prod-info">
                              <a href="{{url('cliente/zona', $zona->slug )}}" class="txt-muted"><h4>{{$zona->name}}</h4></a>
                              <div class="m-b-10">
