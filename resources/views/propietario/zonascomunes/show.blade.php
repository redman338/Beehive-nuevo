         ...
         <div class="col-lg-4">
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('cliente/zona', $zonacomun->slug)}}">{{ $zonacomun->name}}</a> </li>
                ...
                <div class="row">
                        ...
                        <div class="port_details_all_img row">
                            <div class="col-lg-12 m-b-15">
                                <div id="big_banner" class="slick-initialized slick-slider">
                                     @if($zonacomun->file)
                                        <img src="{{$zonacomun->file}}" class="img-fluid o-hidden" alt="prod1.jpg">
                                        @else
                    ...
                    <div class="col-lg-7 col-xs-12 product-detail" id="product-detail">
                       ...
                       <div class="col-lg-12 col-sm-12 mob-product-btn">
                            ...
                            <a href="{{url('cliente/reservas', $zonacomun->slug)}}" class="btn btn-warning waves-effect waves-warning"><i class="icofont icofont-check f-16"></i>Reservar</a>
