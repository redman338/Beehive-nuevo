...
@section('scripts')
  ...
  <script src="{{url('admin/calendario/js/moment.min.js')}}"></script>
  <script src="{{url('admin/calendario/js/jquery.min.js')}}"></script>
  <script src="{{url('admin/calendario/js/fullcalendar.min.js')}}"></script>
