        ...
        <div class="homeContainer">
         ...
         @if($value->url_banner)
            <div class="imgPPrincipal">
                <img src="{{$value->url_banner}}" class="" height="400" width="100%">
            </div>
        @else
            <div class="imgPPrincipal">
            ...
            <div class="imgAmenidad">
                ...
                @if($value->url_card_1)
                    <div class="col">
                        ...
                        <img src="{{$value->url_card_1}}" class="card-img">
                ...
                @endif
                 ...
                 @if($value->url_card_2)
                    <div class="col">
                        <div class="card bg-dark text-white">
                        <img src="{{$value->url_card_2}}" class="card-img">
                           <!--  <div class="card-img-overlay">
                                <h5 class="card-title">Card title</h5>
                            </div> -->
                        </div>
                ...
                @if($value->url_card_3)
                    <div class="col">
                        <div class="card bg-dark text-white">
                        <img src="{{$value->url_card_3}}" class="card-img">
                            <!-- <div class="card-img-overlay">
                                <h5 class="card-title">Card title</h5>
                            </div> -->
                        </div>
                ...
                @endif
                 ...
                 @if($value->url_card_4)
                    <div class="col">
                        <div class="card bg-dark text-white">
                        <img src="{{$value->url_card_4}}" class="card-img">
                            <!-- <div class="card-img-overlay">
                                <h5 class="card-title">Card title</h5>
                            </div> -->
                        </div>
