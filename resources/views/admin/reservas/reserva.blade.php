                    ...
                    <div class="col-lg-4">
                        <div class="page-header-breadcrumb">
                            <ul class="breadcrumb-title">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('reservas.create')}}">Zonas Comunes</a> </li>
                                <li class="breadcrumb-item"><a href="#">{{ $z->name}}</a> </li>
...
@include('admin.reservas.partials.form_reserva_modal')
@include('admin.reservas.partials.info_event')
@endforeach
