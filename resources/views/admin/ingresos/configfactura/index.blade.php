                      ...
                      <table id="simpletable" class="table table-striped table-bordered nowrap">                          
                        <thead>
                          ...
                          <tbody>
                            ...
                            @foreach($configFactura as $value)
                            <tr>
                              <td width="5px"> 
                                {{ $value->id }}
                              </td>
                              ...
                              @can('conceptosfinancieros-edit') 
                                ...
                                <td width="5px">
                                  <div class="icon-btn">
                                  <a href="{{url('configfactura.edit', $value->id)}}"  class="btn btn-inverse btn-icon"><i class="icofont icofont-ui-edit"></i></a>
                                  </div>
                                </td>   
                              @endcan
                              ...
                              @can('conceptosfinancieros-destroy')
                                <td width="5px">
                                  <div class="icon-btn">           
                                      ...
                                      {!! Form::open(['route'=>['configfactura.destroy', $value->id], 
                                        'method' => 'DELETE']) !!}
